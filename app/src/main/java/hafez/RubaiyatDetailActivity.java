...
public class RubaiyatDetailActivity extends AppCompatActivity {
    ...
    // نگاشت عنوان رباعی به لینک صوتی Google Drive (فعلاً خالی، بعداً پر کنید)
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        //put("رباعی شماره ۱", "لینک صوتی"); // بعداً لینک‌ها رو اضافه کنید
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // دریافت عنوان رباعی از Intent
        rubaiyatTitle = getIntent().getStringExtra("rubaiyatTitle");
        if (rubaiyatTitle != null) {
            toolbarTitle.setText(rubaiyatTitle);
        }

        // بارگذاری ابیات رباعی
        List<Verse> verseList = loadVersesFromJson(rubaiyatTitle);
        ...
        // بررسی وضعیت علاقه‌مندی برای رباعی فعلی
        isFavorite = mutableFavorites.contains(rubaiyatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(rubaiyatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(rubaiyatTitle);
    ...
    private List<Verse> loadVersesFromJson(String rubaiyatTitle) {
