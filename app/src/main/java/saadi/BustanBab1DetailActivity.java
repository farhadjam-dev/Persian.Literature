...
public class BustanBab1DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab1Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب اول", "https://example.com/bustan_bab1_poem1.mp3");
        put("شعر دوم باب اول", "https://example.com/bustan_bab1_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab1_detail);
        ...
        bustanBab1Title = getIntent().getStringExtra("bustanBab1Title");
        if (bustanBab1Title != null) {
            toolbarTitle.setText(bustanBab1Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab1Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab1Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab1Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab1Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab1Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab1Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab1Title) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.bustan_bab1);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab1Title)) {
