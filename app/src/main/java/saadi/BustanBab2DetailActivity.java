...
public class BustanBab2DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab2Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب دوم", "https://example.com/bustan_bab2_poem1.mp3");
        put("شعر دوم باب دوم", "https://example.com/bustan_bab2_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab2_detail);
        ...
        bustanBab2Title = getIntent().getStringExtra("bustanBab2Title");
        if (bustanBab2Title != null) {
            toolbarTitle.setText(bustanBab2Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab2Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab2Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab2Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab2Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab2Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab2Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab2Title) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab2Title)) {
