...
public class MavaezRobaiiatDetailActivity extends AppCompatActivity {
    ...
    private String mavaezRobaiiatTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("رباعی اول مواعظ", "https://example.com/mavaez_robaiiat_poem1.mp3");
        put("رباعی دوم مواعظ", "https://example.com/mavaez_robaiiat_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_robaiiat_detail);
        ...
        mavaezRobaiiatTitle = getIntent().getStringExtra("mavaezRobaiiatTitle");
        if (mavaezRobaiiatTitle != null) {
            toolbarTitle.setText(mavaezRobaiiatTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezRobaiiatTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezRobaiiatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezRobaiiatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezRobaiiatTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezRobaiiatTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezRobaiiatTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezRobaiiatTitle) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.mavaez_robaiiat);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezRobaiiatTitle)) {
