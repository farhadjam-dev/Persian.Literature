...
public class BustanBab10DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab10Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب دهم", "https://example.com/bustan_bab10_poem1.mp3");
        put("شعر دوم باب دهم", "https://example.com/bustan_bab10_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab10_detail);
        ...
        bustanBab10Title = getIntent().getStringExtra("bustanBab10Title");
        if (bustanBab10Title != null) {
            toolbarTitle.setText(bustanBab10Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab10Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab10Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab10Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab10Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab10Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab10Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab10Title) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab10Title)) {
