...
public class MavaezMasnaviDetailActivity extends AppCompatActivity {
    ...
    private String mavaezMasnaviTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("مثنوی اول مواعظ", "https://example.com/mavaez_masnavi_poem1.mp3");
        put("مثنوی دوم مواعظ", "https://example.com/mavaez_masnavi_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_masnavi_detail);
        ...
        mavaezMasnaviTitle = getIntent().getStringExtra("mavaezMasnaviTitle");
        if (mavaezMasnaviTitle != null) {
            toolbarTitle.setText(mavaezMasnaviTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezMasnaviTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezMasnaviTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezMasnaviTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezMasnaviTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezMasnaviTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezMasnaviTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezMasnaviTitle) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezMasnaviTitle)) {
