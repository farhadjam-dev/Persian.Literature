...
public class SaadiGhitaatDetailActivity extends AppCompatActivity {
    ...
    private String saadiGhitaatTitle;
    private MediaPlayer mediaPlayer;
    private Handler handler = new Handler(Looper.getMainLooper());
    private boolean isPlaying = false;

    // نگاشت عنوان قطعه به لینک صوتی (مثال)
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        // بعداً لینک‌های واقعی اضافه کنید
        put("قطعه شماره ۱ سعدی", "https://example.com/saadi_ghitaat_1.mp3");
        put("قطعه شماره ۲ سعدی", "https://example.com/saadi_ghitaat_2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saadi_ghitaat_detail);
        ...
        saadiGhitaatTitle = getIntent().getStringExtra("saadiGhitaatTitle");
        if (saadiGhitaatTitle != null) {
            toolbarTitle.setText(saadiGhitaatTitle);
        }

        List<Verse> verseList = loadVersesFromJson(saadiGhitaatTitle);
        ...
        isFavorite = mutableFavorites.contains(saadiGhitaatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(saadiGhitaatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(saadiGhitaatTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(saadiGhitaatTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این قطعه یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), saadiGhitaatTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String saadiGhitaatTitle) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(saadiGhitaatTitle)) {
