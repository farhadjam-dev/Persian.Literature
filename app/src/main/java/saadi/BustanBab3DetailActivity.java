...
public class BustanBab3DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab3Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب سوم", "https://example.com/bustan_bab3_poem1.mp3");
        put("شعر دوم باب سوم", "https://example.com/bustan_bab3_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab3_detail);
        ...
        bustanBab3Title = getIntent().getStringExtra("bustanBab3Title");
        if (bustanBab3Title != null) {
            toolbarTitle.setText(bustanBab3Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab3Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab3Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab3Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab3Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab3Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab3Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab3Title) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.bustan_bab3);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab3Title)) {
