...
public class BustanBab5DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab5Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب پنجم", "https://example.com/bustan_bab5_poem1.mp3");
        put("شعر دوم باب پنجم", "https://example.com/bustan_bab5_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab5_detail);
        ...
        bustanBab5Title = getIntent().getStringExtra("bustanBab5Title");
        if (bustanBab5Title != null) {
            toolbarTitle.setText(bustanBab5Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab5Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab5Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab5Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab5Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab5Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab5Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab5Title) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab5Title)) {
