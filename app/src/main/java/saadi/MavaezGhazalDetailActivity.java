...
public class MavaezGhazalDetailActivity extends AppCompatActivity {
    ...
    private String mavaezGhazalTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("غزل اول مواعظ", "https://example.com/mavaez_ghazal_poem1.mp3");
        put("غزل دوم مواعظ", "https://example.com/mavaez_ghazal_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_ghazal_detail);
        ...
        mavaezGhazalTitle = getIntent().getStringExtra("mavaezGhazalTitle");
        if (mavaezGhazalTitle != null) {
            toolbarTitle.setText(mavaezGhazalTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezGhazalTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezGhazalTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezGhazalTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezGhazalTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezGhazalTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezGhazalTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezGhazalTitle) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.mavaez_ghazal);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezGhazalTitle)) {
