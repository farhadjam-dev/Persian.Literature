...
public class BustanNiyayeshDetailActivity extends AppCompatActivity {
    ...
    private String bustanNiyayeshTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("نیایش اول", "https://example.com/bustan_niyayesh_1.mp3");
        put("نیایش دوم", "https://example.com/bustan_niyayesh_2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_niyayesh_detail);
        ...
        bustanNiyayeshTitle = getIntent().getStringExtra("bustanNiyayeshTitle");
        if (bustanNiyayeshTitle != null) {
            toolbarTitle.setText(bustanNiyayeshTitle);
        }

        List<Verse> verseList = loadVersesFromJson(bustanNiyayeshTitle);
        ...
        isFavorite = mutableFavorites.contains(bustanNiyayeshTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanNiyayeshTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanNiyayeshTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanNiyayeshTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این نیایش یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanNiyayeshTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanNiyayeshTitle) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.bustan_niyayesh);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanNiyayeshTitle)) {
