...
public class MavaezMarasiDetailActivity extends AppCompatActivity {
    ...
    private String mavaezMarasiTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("مرثیه اول مواعظ", "https://example.com/mavaez_marasi_poem1.mp3");
        put("مرثیه دوم مواعظ", "https://example.com/mavaez_marasi_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_marasi_detail);
        ...
        mavaezMarasiTitle = getIntent().getStringExtra("mavaezMarasiTitle");
        if (mavaezMarasiTitle != null) {
            toolbarTitle.setText(mavaezMarasiTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezMarasiTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezMarasiTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezMarasiTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezMarasiTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezMarasiTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezMarasiTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezMarasiTitle) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.mavaez_marasi);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezMarasiTitle)) {
