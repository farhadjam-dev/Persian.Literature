...
public class MavaezArabicDetailActivity extends AppCompatActivity {
    ...
    private String mavaezArabicTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول مواعظ عربی", "https://example.com/mavaez_arabic_poem1.mp3");
        put("شعر دوم مواعظ عربی", "https://example.com/mavaez_arabic_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_arabic_detail);
        ...
        mavaezArabicTitle = getIntent().getStringExtra("mavaezArabicTitle");
        if (mavaezArabicTitle != null) {
            toolbarTitle.setText(mavaezArabicTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezArabicTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezArabicTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezArabicTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezArabicTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezArabicTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezArabicTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezArabicTitle) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezArabicTitle)) {
