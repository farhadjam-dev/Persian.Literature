...
public class MavaezGhetaatDetailActivity extends AppCompatActivity {
    ...
    private String mavaezGhetaatTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("قطعه اول مواعظ", "https://example.com/mavaez_ghetaat_poem1.mp3");
        put("قطعه دوم مواعظ", "https://example.com/mavaez_ghetaat_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_ghetaat_detail);
        ...
        mavaezGhetaatTitle = getIntent().getStringExtra("mavaezGhetaatTitle");
        if (mavaezGhetaatTitle != null) {
            toolbarTitle.setText(mavaezGhetaatTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezGhetaatTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezGhetaatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezGhetaatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezGhetaatTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezGhetaatTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezGhetaatTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezGhetaatTitle) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.mavaez_ghetaat);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezGhetaatTitle)) {
