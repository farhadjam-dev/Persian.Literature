...
public class MavaezMosallasatActivity extends AppCompatActivity {
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        put("مثلثات مواعظ", "https://example.com/mavaez_mosallasat_poem.mp3"); // لینک واقعی بعداً اضافه بشه
    }};
