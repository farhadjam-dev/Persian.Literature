...
public class MavaezGhaseedahDetailActivity extends AppCompatActivity {
    ...
    private String mavaezGhaseedahTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("قصیده اول مواعظ", "https://example.com/mavaez_ghaseedah_poem1.mp3");
        put("قصیده دوم مواعظ", "https://example.com/mavaez_ghaseedah_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_ghaseedah_detail);
        ...
        mavaezGhaseedahTitle = getIntent().getStringExtra("mavaezGhaseedahTitle");
        if (mavaezGhaseedahTitle != null) {
            toolbarTitle.setText(mavaezGhaseedahTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezGhaseedahTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezGhaseedahTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezGhaseedahTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezGhaseedahTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezGhaseedahTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezGhaseedahTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezGhaseedahTitle) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezGhaseedahTitle)) {
