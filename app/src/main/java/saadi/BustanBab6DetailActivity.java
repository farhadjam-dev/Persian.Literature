...
public class BustanBab6DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab6Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب ششم", "https://example.com/bustan_bab6_poem1.mp3");
        put("شعر دوم باب ششم", "https://example.com/bustan_bab6_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab6_detail);
        ...
        bustanBab6Title = getIntent().getStringExtra("bustanBab6Title");
        if (bustanBab6Title != null) {
            toolbarTitle.setText(bustanBab6Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab6Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab6Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab6Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab6Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab6Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab6Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab6Title) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.bustan_bab6);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab6Title)) {
