...
public class BustanBab7DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab7Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب هفتم", "https://example.com/bustan_bab7_poem1.mp3");
        put("شعر دوم باب هفتم", "https://example.com/bustan_bab7_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab7_detail);
        ...
        bustanBab7Title = getIntent().getStringExtra("bustanBab7Title");
        if (bustanBab7Title != null) {
            toolbarTitle.setText(bustanBab7Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab7Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab7Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab7Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab7Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab7Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab7Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab7Title) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab7Title)) {
