...
public class MavaezMosallasatDetailActivity extends AppCompatActivity {
    ...
    private String mavaezMosallasatTitle;
    private MediaPlayer mediaPlayer;
    private Handler handler = new Handler(Looper.getMainLooper());
    private boolean isPlaying = false;

    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        // لینک واقعی بعداً اضافه بشه
        put("مثلثات مواعظ", "https://example.com/mavaez_mosallasat_poem.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_mosallasat_detail);
        ...
        // عنوان ثابت برای تنها شعر مثلثات
        mavaezMosallasatTitle = "مثلثات مواعظ";
        toolbarTitle.setText(mavaezMosallasatTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezMosallasatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezMosallasatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezMosallasatTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezMosallasatTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezMosallasatTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson() {
        ...
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.mavaez_mosallasat);
            ...
            JSONObject jsonObject = jsonArray.getJSONObject(0); // فقط یه شعر داریم
