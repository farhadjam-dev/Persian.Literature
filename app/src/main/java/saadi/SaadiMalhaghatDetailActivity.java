...
public class SaadiMalhaghatDetailActivity extends AppCompatActivity {
    ...
    private String saadiMalhaghatTitle;
    private MediaPlayer mediaPlayer;
    private Handler handler = new Handler(Looper.getMainLooper());
    private boolean isPlaying = false;

    // نگاشت عنوان ملحقات به لینک صوتی (مثال)
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        // بعداً لینک‌های واقعی اضافه کنید
        put("ملحقات شماره ۱ سعدی", "https://example.com/saadi_malhaghat_1.mp3");
        put("ملحقات شماره ۲ سعدی", "https://example.com/saadi_malhaghat_2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saadi_malhaghat_detail);
        ...
        saadiMalhaghatTitle = getIntent().getStringExtra("saadiMalhaghatTitle");
        if (saadiMalhaghatTitle != null) {
            toolbarTitle.setText(saadiMalhaghatTitle);
        }

        List<Verse> verseList = loadVersesFromJson(saadiMalhaghatTitle);
        ...
        isFavorite = mutableFavorites.contains(saadiMalhaghatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(saadiMalhaghatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(saadiMalhaghatTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(saadiMalhaghatTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این ملحقات یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), saadiMalhaghatTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String saadiMalhaghatTitle) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(saadiMalhaghatTitle)) {
