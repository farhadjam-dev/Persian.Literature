...
public class MavaezMofradatDetailActivity extends AppCompatActivity {
    ...
    private String mavaezMofradatTitle;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("مفرد اول مواعظ", "https://example.com/mavaez_mofradat_poem1.mp3");
        put("مفرد دوم مواعظ", "https://example.com/mavaez_mofradat_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mavaez_mofradat_detail);
        ...
        mavaezMofradatTitle = getIntent().getStringExtra("mavaezMofradatTitle");
        if (mavaezMofradatTitle != null) {
            toolbarTitle.setText(mavaezMofradatTitle);
        }

        List<Verse> verseList = loadVersesFromJson(mavaezMofradatTitle);
        ...
        isFavorite = mutableFavorites.contains(mavaezMofradatTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(mavaezMofradatTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(mavaezMofradatTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(mavaezMofradatTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), mavaezMofradatTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String mavaezMofradatTitle) {
        List<Verse> verseList = new ArrayList<>();
        try {
            InputStream inputStream = getResources().openRawResource(R.raw.mavaez_mofradat);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(mavaezMofradatTitle)) {
