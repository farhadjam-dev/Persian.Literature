...
public class BustanBab4DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab4Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب چهارم", "https://example.com/bustan_bab4_poem1.mp3");
        put("شعر دوم باب چهارم", "https://example.com/bustan_bab4_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab4_detail);
        ...
        bustanBab4Title = getIntent().getStringExtra("bustanBab4Title");
        if (bustanBab4Title != null) {
            toolbarTitle.setText(bustanBab4Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab4Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab4Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab4Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab4Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab4Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab4Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab4Title) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab4Title)) {
