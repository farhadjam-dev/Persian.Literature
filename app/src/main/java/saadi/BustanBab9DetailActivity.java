...
public class BustanBab9DetailActivity extends AppCompatActivity {
    ...
    private String bustanBab9Title;
    ...
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        ...
        put("شعر اول باب نهم", "https://example.com/bustan_bab9_poem1.mp3");
        put("شعر دوم باب نهم", "https://example.com/bustan_bab9_poem2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bustan_bab9_detail);
        ...
        bustanBab9Title = getIntent().getStringExtra("bustanBab9Title");
        if (bustanBab9Title != null) {
            toolbarTitle.setText(bustanBab9Title);
        }

        List<Verse> verseList = loadVersesFromJson(bustanBab9Title);
        ...
        isFavorite = mutableFavorites.contains(bustanBab9Title);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(bustanBab9Title);
                ...
                isFavorite = true;
                mutableFavorites.add(bustanBab9Title);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(bustanBab9Title);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این شعر یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), bustanBab9Title.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String bustanBab9Title) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(bustanBab9Title)) {
