...
public class SaadiGhazalDetailActivity extends AppCompatActivity {
    ...
    private String saadiGhazalTitle;
    private MediaPlayer mediaPlayer;
    private Handler handler = new Handler(Looper.getMainLooper());
    private boolean isPlaying = false;

    // نگاشت عنوان غزل به لینک صوتی (مثال)
    private static final Map<String, String> AUDIO_URLS = new HashMap<String, String>() {{
        // بعداً لینک‌های واقعی اضافه کنید
        put("غزل شماره ۱ سعدی", "https://example.com/saadi_ghazal_1.mp3");
        put("غزل شماره ۲ سعدی", "https://example.com/saadi_ghazal_2.mp3");
    }};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saadi_ghazal_detail);
        ...
        saadiGhazalTitle = getIntent().getStringExtra("saadiGhazalTitle");
        if (saadiGhazalTitle != null) {
            toolbarTitle.setText(saadiGhazalTitle);
        }

        List<Verse> verseList = loadVersesFromJson(saadiGhazalTitle);
        ...
        isFavorite = mutableFavorites.contains(saadiGhazalTitle);
        ...
        favoriteButton.setOnClickListener(v -> {
            ...
            if (isFavorite) {
                isFavorite = false;
                mutableFavorites.remove(saadiGhazalTitle);
                ...
                isFavorite = true;
                mutableFavorites.add(saadiGhazalTitle);
    ...
    private void playAudio() {
        String audioUrl = AUDIO_URLS.get(saadiGhazalTitle);
        if (audioUrl == null) {
            Toast.makeText(this, "فایل صوتی برای این غزل یافت نشد", Toast.LENGTH_SHORT).show();
            return;
        }

        File cacheFile = new File(getCacheDir(), saadiGhazalTitle.replace(" ", "_") + ".mp3");
    ...
    private List<Verse> loadVersesFromJson(String saadiGhazalTitle) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                if (title.equals(saadiGhazalTitle)) {
